/**
 * ! Bug di total used spray pertama
 * -> Di soal : total used full tank 4,5 sedangkan hasil kalkulasi seharusnya 67,5
 * -> di soal : total used full tank 1,5 sedangkan hasil kalkulasi seharusnya 22,5
 * -> di soal : total used full 9 kg sedangkan hasil kalkulasi seharusnya 135
 * -> di soal : total used part 3,69 kg sedangkan hasil kalkulasi seharusnya 3,67
 */
// Import dependencies
...
// Fungsi untuk mengubah string menjadi number, jika kosong/null jadi 0
...
// Endpoint utama untuk calculation
app.post('/calculate-spray', (req, res) => {
    try {
